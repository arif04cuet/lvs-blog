...
class Index extends Controller
{
    ...
    public function index()
    {
        ...
        $this->bodyClass = 'compact-container staic-page';
    ...
    protected function getContentTemplateList()
    {
         ...
         * Extensibility
         */
        if (($event = $this->fireEvent('content.templateList', [$templates], true)) || ($event = Event::fire('pages.content.templateList', [$this, $templates], true))) {
            return $event;
        }
